...
| [Authentication Digest](https://start.ktor.io/p/io.ktor/server-auth-digest) | Handles 'Digest' authentication scheme |
| [Authentication JWT](https://start.ktor.io/p/io.ktor/server-auth-jwt) | Handles JSON Web Token (JWT) bearer authentication scheme |
| [Authentication LDAP](https://start.ktor.io/p/io.ktor/server-auth-ldap) | Handles Lightweight Directory Access Protocol (LDAP) authentication |
